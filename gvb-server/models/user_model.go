...
type UserModel struct {
	...
	ArticleModels  []ArticleModel   `json:"-" gorm:"foreignKey:AuthID"`                                                       // 发布的文章列表
	CollectsModels []ArticleModel   `json:"-" gorm:"many2many:auth2_collects;joinForeignKey:AuthID;JoinReferences:ArticleID"` // 收藏的文章列表
}
